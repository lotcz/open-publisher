...
export default function DestinationPreview({destination}: DestinationPreviewParams) {
	...
	return <div className="article-preview" style={style}>
		<h2>Náhled článku {destination.name}</h2>
		<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras in sollicitudin metus. In hac habitasse platea dictumst. Pellentesque
		...
		<p>Maecenas ornare bibendum neque, vitae cursus nibh lobortis a. Proin lobortis velit turpis, et condimentum elit dapibus eget. Proin ut
			ullamcorper tortor, ac <a>pellentesque</a> tellus. Nunc ipsum dolor, ornare vitae consectetur sed, tincidunt nec ipsum. Mauris id nibh
			quis urna
			...
			fermentum, sed rhoncus est condimentum. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas.
